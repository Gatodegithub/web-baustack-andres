    ...
    <footer className="container border-top">
      <div className="row mx-auto pt-4">
        <div className="col-md-4">
          ...
          <ul className="list-unstyled contact-list ml-4">
            <li>(+569) 9451 5329</li>
            <li>(+569) 8804 0293</li>
        ...
        <div className="col-md-4">
          <h4>Síguenos en:</h4>
          <ul className="list-unstyled d-flex justify-content-start text-left pt-2">
            <li className="pr-3">
              <svg
      ...
      <div className="row">
        <div className="col-lg-12">
          <p className="text-center py-3">2021 Todos los derechos reservados baustack.com</p>
        </div>
      </div>
    </footer>
  );
